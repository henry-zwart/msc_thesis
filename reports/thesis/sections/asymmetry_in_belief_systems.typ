...
#figure(
  image("../results/figures/model/directional_differentials/rank_no_use_covariates_no_structure.pdf"),
  caption: caption(
...
#figure(
  image("../results/figures/model/intervention_collective_ranking/05_no_use_covariates_climate_policy.pdf"),
  caption: caption(
...
#figure(
  image("../results/figures/model/intervention_collective_ranking/10_no_use_covariates_climate_policy.pdf"),
  caption: caption(
    short: [
...
#figure(
  image("../results/figures/model/intervention_collective_ranking/80_no_use_covariates_climate_policy.pdf"),
  caption: caption(
    short: [
...
#figure(
  image("../results/figures/model/intervention_collective_effect/05_no_use_covariates_climate_policy.pdf"),
  caption: caption(
...
#figure(
  image("../results/figures/model/intervention_collective_effect/10_no_use_covariates_climate_policy.pdf"),
  caption: caption(
    short: [
...
#figure(
  image("../results/figures/model/intervention_collective_effect/80_no_use_covariates_climate_policy.pdf"),
  caption: caption(
    short: [
