...
Increased recent polarisation on urgent issues such as climate change and public health
...
prevalent of which considers belief systems as interrelated networks of beliefs---have
emerged as a valuable lens through which to understand belief dynamics in terms of
interactions in a larger belief system. Most authors in this field acknowledge
...
symmetric influence between beliefs. In theory, this assumption directly impacts
belief dynamics as well as common methods for assessing belief importance. In practice,
...
dynamics which supports both symmetric and asymmetric influence assumptions. We then
derive a parameter estimation method which we use to calibrate the model to a
longitudinal dataset on climate-related beliefs in the US ($n=1693$). In the second half
...
comparing the structural features of conservative and liberal belief systems. Our findings
support the existence of asymmetric influences
between beliefs, demonstrating that these appear to be structured around a small set
of highly 'influential' beliefs which are difficult to influence. We show that when
such beliefs are present, models that assume symmetric influence may lead to spurious
conclusions about the relative importance of beliefs, and different conclusions regarding
