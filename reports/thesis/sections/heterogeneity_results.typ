...
#figure(
  image("../results/figures/model/intervention_individual_ranking/05_no_use_covariates_climate_policy.pdf"),
  caption: caption(
...
#figure(
  image("../results/figures/model/intervention_individual_ranking/80_no_use_covariates_climate_policy.pdf"),
  caption: caption(
